...
cd $DIR
echo "------------------------------------------------" >> ./results/non-inclusion-variation/results.txt 2>&1
echo "--- Create Proof------------------ -----------------" >> ./results/non-inclusion-variation/results.txt 2>&1
python3 ./scripts/analyse_time.py ./results/non-inclusion-variation/create-proof.csv >> ./results/non-inclusion-variation/results.txt 2>&1
echo "------------------------------------------------" >> ./results/non-inclusion-variation/results.txt 2>&1
echo "------------------------------------------------" >> ./results/non-inclusion-variation/results.txt 2>&1
echo "--- Verify Proof------------------ -----------------" >> ./results/non-inclusion-variation/results.txt 2>&1
python3 ./scripts/analyse_time.py ./results/non-inclusion-variation/verify-proof.csv >> ./results/non-inclusion-variation/results.txt 2>&1
echo "------------------------------------------------" >> ./results/non-inclusion-variation/results.txt 2>&1
echo "------------------------------------------------" >> ./results/non-inclusion-variation/results.txt 2>&1
