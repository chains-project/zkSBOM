#!/bin/bash
#
# install-windows.sh - Build zkSBOM Verifier on Windows (Git Bash)
#
# Prerequisites:
#   - Git (with Git Bash)
...
echo ""
echo "=========================================="
echo " zkSBOM Verifier Windows Build"
echo "=========================================="
echo ""
...
echo "=========================================="
echo ""
echo "Binary: target/release/zksbom-verifier.exe"
