...
Follow the installation section in the corresponding README.md to install [zkSBOM Operator](./zksbom-operator/README.md#Installation) or [zkSBOM Verifier](./zksbom-verifier/README.md#Installation).
